...
var App = function () {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (height >= content.height()) {
                ...
                content.attr('style', 'min-height:' + (parseInt(height)-2).toString() + 'px !important');//减少2个像素
            }
        }
    }
    ...
    var handleTheme = function () {
        ...
        var setLayout = function () {
            ...
            var sidebarOption = "fixed"; //$('.sidebar-option', panel).val();
            var headerOption = "fixed"; //$('.header-option', panel).val();
            var footerOption = "fixed"; //$('.footer-option', panel).val();
    ...
    return {
        ...
        init: function () {
            ...
            //handleFixInputPlaceholderForIE(); // fixes/enables html5 placeholder attribute for IE9, IE8//不显示placeholder，影响val的值
