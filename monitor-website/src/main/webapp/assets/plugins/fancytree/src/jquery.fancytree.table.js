...
myglyph_opts = {
    map: {
        ...
        checkbox: "glyphicon glyphicon-unchecked fa-lg",
        checkboxSelected: "glyphicon glyphicon-check fa-lg",
        checkboxUnknown: "glyphicon glyphicon-share",
        dragHelper: "glyphicon glyphicon-play",
        dropMarker: "glyphicon glyphicon-arrow-right",
        error: "glyphicon glyphicon-warning-sign",
        expanderClosed: "fa fa-angle-right",
        expanderLazy: "fa fa-angle-right",  // glyphicon-plus-sign
        expanderOpen: "fa fa-angle-down",  // glyphicon-collapse-down
