    ...
    if($.Datatype){
        ...
        $.extend($.Datatype,{
            ...
            */
            ...
            "timeYZ":/^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-8]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-)) (20|21|22|23|[0-1]?\d):[0-5]?\d:[0-5]?\d$/,
            ...
            "money":/^([\u0024\u00A2\u00A3\u00A4\u20AC\u00A5\u20B1\20B9\uFFE5]\s*)(\d+,?)+\.?\d*\s*$/,
            //唐璜写的货品类型;
            "DonJuanMoeny":/^((\d{1,3}(,\d{3})+?|\d+)(\.\d{2})?|(\.\d{2}))$/,
            ...
            */
            ...
            "num":/^(\d+[\s,]*)+\.?\d*$/,
              ...
              "funum":/^-?(\d+[\s,]*)+\.?\d*$/,
              "funum1-5":/^((([0-9]{1,4})|([0-9]{1,4})\.\d{1,2})|(-[1]))$/,
            //整数
            "Integer1-12":/^(([1-9][0-9]{0,11})|([0]))$/,
             "Integer1-6":/^(([1-9][0-9]{0,5})|([0]))$/,
              "Integer1-8":/^(([1-9][0-9]{0,7})|([0]))$/,
              "Integer1-8True":/^[1-9][0-9]{0,7}$/,
            //QQ号码;
            "qq":/^[1-9][0-9]{4,9}$/,
            //手机号码;
            "Phone":/^[1]([1-9][0-9]{1}|59|58|88|89)[0-9]{8}$/,
            //姓名
            "Name":/^[\da-zA-Z\u4E00-\u9FA5]{1,7}$/,
            //邮箱;
            "Email":/^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/,
            ...
            "BirthDate2":/^\d{4}\/\d{2}\/\d{2}$/,
            "Dec122":/^(-?([1-9]\d{0,11}(\.\d{1,2})?)|(0(\.\d{1,2})?))$/,//12整数，2小数
            "UnDec122":/^(([1-9]\d{0,11}(\.\d{1,2})?)|(0(\.\d{1,2})?))$/,//12整数，2小数 不含负数
            "Dec102":/^(-?([1-9]\d{0,9}(\.\d{1,2})?)|(0(\.\d{1,2})?))$/,//10整数，2小数
            "UnDec102":/^(([1-9]\d{0,9}(\.\d{1,2})?)|(0(\.\d{1,2})?))$/,//10整数，2小数 不烦负数

            
            "Dec162":/^(-?([1-9]\d{0,15}(\.\d{1,2})?)|(0(\.\d{1,2})?))$/,//16整数，2小数
            "UnDec162":/^(([1-9]\d{0,15}(\.\d{1,2})?)|(0(\.\d{1,2})?))$/,//16整数，2小数 不烦负数
            /*
              参数gets是获取到的表单元素值，
              obj为当前表单元素，
              curform为当前验证的表单，
            ...
            */
            ...
            "numrange":function(gets,obj,curform,datatype){
                ...
                */
                ...
                return  true;
                    ...
                    "numranges":function(gets,obj,curform,datatype){
                /*
                    判断数值范围 可以判断小数范围
                    注意需要给表单元素绑定max,min属性来指定最大或最小可输入的值，没有绑定的话使用默认值
                */
            ...
            "DecimalNum":/^((([1-9][0-9]{0,1})|([0]{1}))(\.\d{1,4})?|100|100\.0|100\.00|100\.000|100\.0000)$/,//数字1-100，且小数点最多四位数
            "NumDecimal2":/^(([1-9][0-9]{0,3})|([0]{1}))(\.\d{1,2})?$/, //数字大于0小于等于4位，且小数点最多二位数
            "NumDecimal3":/^(([1-9][0-9]{0,11})|([0]{1}))(\.\d{1,2})?$/, //数字大于0小于等于12位，且小数点最多二位数
