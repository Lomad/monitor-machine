...
<head>
    ...
    <link href="${contextPath}/assets/plugins/dataTables/dataTables.tableTools.min.css" rel="stylesheet" type="text/css"/>
        ...
        <ul class="page-sidebar-menu">
            ...
            <li class="">
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a href="/admin/permanage">
                            数据权限字典定义
                        </a>
                    </li>
                    <li>
                        <a href="/admin/propmanage">
                            属性权限字典设置
                        </a>
                    </li>
                    <li>
                        <a href="/admin/proppower">
                            属性权限管理
                        </a>
                    </li>
                    <li>
                        <a href="/admin/datapower">
                            数据权限管理
                        </a>
                    </li>
                    <li>
                        <a href="/admin/basedic">
                            基础字典设置
                        </a>
                    </li>
                    <li>
